...
function BookingModal({close,selectedRoom}:{close:()=>void;selectedRoom?:string}){
 ...
 const submit=(e:any)=>{e.preventDefault();const msg=`مرحباً فندق بانوراما، أرغب في حجز غرفة.\nالاسم: ${form.name}\nالجوال: ${form.phone}\nالوصول: ${form.checkIn}\nالمغادرة: ${form.checkOut}\nالأشخاص: ${form.guests}\nالغرفة: ${form.room}`;window.open('https://wa.me/'+WA+'?text='+encodeURIComponent(msg),'_blank');setSent(true)};
